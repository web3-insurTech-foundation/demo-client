...
@NgModule({
    imports: [RouterModule.forChild([
        { path: '', data: {breadcrumb: 'System Dashboard'}, loadChildren: () => import('./sales/dashboardsales.module').then(m => m.DashboardSalesModule) },
        ...
        { path: 'dashboard-saas', data: {breadcrumb: 'DAO Dashboard'}, loadChildren: () => import('./saas/dashboardsaas.module').then(m => m.DashboardSaasModule) },
